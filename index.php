    ...
    <div class="outlet-block">
      ...
      <form action="form_page_2.php" medthod="GET">
        <div class="inside-block">
          <h2>First Name : <input type="text" name="firstName" value="<?php echo $_SESSION['firstName']; ?>"></h2>
          <h2>Last Name : <input type="text" name="lastName" style="margin-left: 1%;" value="<?php echo $_SESSION['lastName']; ?>"></h2>
          <h2>Gender <input type="radio" name="gender" checked="<?php echo $_SESSION['gender'] == 'male'; ?>" value="male"> Male <input type="radio" name="gender" checked="<?php echo $_SESSION['gender'] == 'female'; ?>" value="female"> Female</h2>
          <h2>Age <input type="number" name="age" min="1" max="120" value="<?php echo $_SESSION['age']; ?>"></h2>
